      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <div className="p-5 rounded-2xl bg-gradient-to-br from-grafana-green to-emerald-600 shadow-2xl">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-dict-panel border border-dict-border/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-grafana-green focus:border-transparent transition-all text-foreground placeholder:text-muted-foreground"
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-dict-border/30 bg-dict-panel text-grafana-green focus:ring-2 focus:ring-grafana-green"
                  />
                  <span className="text-sm text-muted-foreground font-medium">Remember me</span>
                </label>
                <button
                  type="button"
                  className="text-sm text-grafana-green hover:text-grafana-green/80 font-semibold transition-colors"
                >
                  Forgot password?
                </button>
              </div>
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-grafana-green to-emerald-600 hover:from-grafana-green/90 hover:to-emerald-600/90 font-semibold tracking-wide py-6 text-base shadow-lg"
                size="lg"
              >
        ...
        <p className="text-center text-sm text-muted-foreground mt-6 font-medium">
          &copy; 2026 DICT - Finance Division
        </p>
      </div>
    </div>
  )
